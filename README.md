...
| [cloudsync](https://github.com/MAXZVER/cloudsync) ↗ | Selective cloud sync with a three-way merge for conflicts, macOS and Windows. Written here, moved out — none of it is XPS-specific |
