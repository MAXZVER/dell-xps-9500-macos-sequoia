...
| [cloudsync-macos](https://github.com/MAXZVER/cloudsync-macos) ↗ | Выборочная синхронизация облака с трёхсторонним слиянием конфликтов. Писалось здесь, вынесено отдельно — к XPS не привязано ничем |
